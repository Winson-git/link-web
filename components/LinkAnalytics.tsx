...
import { ArrowLeft, BarChart3, ExternalLink, Globe, Lock, MousePointer, TrendingUp, User } from "lucide-react";
                ...
                <div className="bg-white/80 backdrop-blur-sm border-2 border-dashed border-gray-300 rounded-2xl p-8 shadow-xl shadow-gray-200/50">
                    ...
                    <div className="mt-6 space-y-6">
                        <div className="flex items-center gap-4 text-gray-600">
                            ...
                            <span>Track total clicks and engagment</span>
                        </div>
                        <div className="flex items-center gap-4 text-gray-600">
                        ...
                        <div className="bg-white/80 backdrop-blur-sm border-2 border-dashed border-gray-300 rounded-2xl p-8 shadow-xl shadow-gray-200/50">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600">
                                        Upgrade to Ultra for detailed country insights
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="max-w-7xl mx-auto">
                        <div className="bg-white/80 backdrop-blur-sm border broder-white/20 rounded-2xl p-8 shadow-xl shadow-gray-200/50">
                            ...
                            {analytics.countryData.length > 20 && (
                                <div className="mt-6 text-center">
                                    <p className="text-gray-500 text-sm">
                                        Showing top {analytics.countryData.length} countries
                                    </p>
                                </div>
                            )}
                        </div>
