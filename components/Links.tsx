...
const Links = ({ preloadedLinks} : { preloadedLinks: Preloaded<typeof api.lib.links.getLinkBySlug>;}) => {
    ...
    if (links.length === 0 ){
        return (
            <div className="text-center pc-20">
                <div className="text-slate-300 mb-6">
                    <ArrowUpRight className="szie-16 mx-auto" />
                </div>
                ...
                >
                    <div className="relative bg-white/70 hover:bg-white/90 border border-slate-200/50 hover:border-slate-300/50 rounded-2xl p-6 transition-all duration-300 hover:shadow-lg hover:shadow-slate-900/5 hover:-translate-y-0.5">
                        ...
                        <div className="relative flex items-center justify-between">
                            ...
                            <div className="ml-4 text-slate-400 group-hover:text-slate-600 translate-all duration-200">
