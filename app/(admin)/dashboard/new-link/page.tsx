...
const NewLinkPage = async () => {
  ...
  // also can do in by using the plan : const hasTenLinkCapacity = has({ plan: "pro" });
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-4 lg:p-8">
            <div className="max-w-7xl mx-auto">
                <div className="bg-white/80 backdrop-blur-sm border border-white/20 rounded-2xl p-8 showdow-xl shadow-gray-200/50">
                    <h2 className="text-2xl font-semibold text-gray-900 mb-4">
                        Link Limit Reached
                    </h2>
                    <p className="text-gray-600 mb-4">
                        You have reached your maximun number of links (
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <p className="text-lg text-gray-600 leading-relaxed">
                                    Add a new link to your link-in-bio page. Your links will appear in the order you create them (you can reorder them later), make it easy for your audience to find what matters most.
                                </p>
